...
<html>
<head>
<title>Waroeng Aqiqah - Keranjang Saya</title>
<!-- for-mobile-apps -->
	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>DAPATKAN HEWAN BERKUALITAS DISINI, <a href="products.html">BELANJA SEKARANG!</a></p>
			</div>
			...
			<div class="checkout-left">	
				<div class="checkout-left-basket">
					...
					<ul>
						...
						?>
						<li>Total (inc. 500k Ongkir)<i> - </i> <span>Rp<?php echo number_format($subtotal) ?></span></li>
					</ul>
				</div>
